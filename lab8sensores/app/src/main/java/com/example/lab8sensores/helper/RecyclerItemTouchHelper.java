package com.example.lab8sensores.helper;
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            ...
            if (this.listener.getClass().getSimpleName().equals("MainActivity")) {
                backgroundViewEdit = ((ContactosAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((ContactosAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((ContactosAdapter.MyViewHolder) viewHolder).viewForeground;
            }
            //Selected item
